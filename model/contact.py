...
class Contact:
    ...
    def __init__(self, firstname=None, middlename=None, lastname=None, nickname=None, image_name=None, title=None,
                 company=None, address=None, home_number=None, mobile_number=None, work_number=None, fax=None,
